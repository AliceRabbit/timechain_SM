...
import com.dizsun.timechain.util.SM2Util;
...
//    }
	...
	public String responseACK() {
		...
		ACK ack = new ACK();
		ack.setVN(vn);
		ack.setPublicKey(sm2Util.getPubPriKey().getPublicKeyBase64());
//		System.out.println("MH sign私钥: " + Util.getHexString(sm2Util.getPubPriKey().getPriKey()));
//		ack.setSign(sm2Util.getPubPriKey().encrypt(sm2Util.getPubPriKey().getPublicKeyBase64() + vn));
		ack.setSign(sm2Util.getPubPriKey().sign(sm2Util.getPubPriKey().getPublicKeyBase64() + vn));
